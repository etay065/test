    ...
    <div class="mec-meta-box-fields" id="mec_meta_box_calendar_skin_options">
        ...
        <div class="mec-skins-options-container">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_list_skin_options_container">
                ...
                <!-- Start Maximum Date -->
                <div class="mec-form-row">
                    <label class="mec-col-4" for="mec_skin_list_maximum_date_range"><?php _e('Maximum Date', 'mec'); ?></label>
                    <input type="text" class="mec-col-4 mec_date_picker" name="mec[sk-options][list][maximum_date_range]" value="<?php echo isset($sk_options_list['maximum_date_range']) ? esc_attr($sk_options_list['maximum_date_range']) : ''; ?>" placeholder="<?php _e('Maximum Date', 'mec'); ?>" autocomplete="off" />
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Maximum Date', 'mec'); ?></h5>
                            <div class="content"><p><?php _e('Show events before the specified date.', 'mec'); ?></p></div>
                        </div>
                ...
                <div class="mec-form-row mec-skin-list-date-format-container <?php if(isset($sk_options_list['style']) and $sk_options_list['style'] != 'classic') echo 'mec-util-hidden'; ?>" id="mec_skin_list_date_format_classic_container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default value is "M d Y"', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/list-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                <div class="mec-form-row mec-skin-list-date-format-container <?php if(isset($sk_options_list['style']) and $sk_options_list['style'] != 'M d Y') echo 'mec-util-hidden'; ?>" id="mec_skin_list_date_format_minimal_container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default values are d, M and l', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/list-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                <div class="mec-form-row mec-skin-list-date-format-container <?php if(isset($sk_options_list['style']) and $sk_options_list['style'] != 'modern') echo 'mec-util-hidden'; ?>" id="mec_skin_list_date_format_modern_container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default values are d, F and l', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/list-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                <div class="mec-form-row mec-skin-list-date-format-container <?php if(isset($sk_options_list['style']) and $sk_options_list['style'] != 'standard') echo 'mec-util-hidden'; ?>" id="mec_skin_list_date_format_standard_container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default value is "M d"', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/list-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                <div class="mec-form-row mec-skin-list-date-format-container <?php if(isset($sk_options_list['style']) and $sk_options_list['style'] != 'accordion') echo 'mec-util-hidden'; ?>" id="mec_skin_list_date_format_accordion_container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('TDefault values are d and F', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/list-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times" id="mec_skin_list_localtime">
					<div class="mec-col-4">
						<label for="mec_skin_list_include_local_time"><?php _e('Include Local Time', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-include-events-times">
					<div class="mec-col-4">
						<label for="mec_skin_list_include_events_times"><?php _e('Include Events Times', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher" id="mec_skin_list_display_normal_label">
					<div class="mec-col-4">
						<label for="mec_skin_list_display_label"><?php _e('Display Normal Labels', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher" id="mec_skin_list_display_reason_for_cancellation">
					<div class="mec-col-4">
						<label for="mec_skin_list_reason_for_cancellation"><?php _e('Display Reason for Cancellation', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher">
					<div class="mec-col-4">
						<label for="mec_skin_list_map_on_top"><?php _e('Show Map on top', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-set-geolocation <?php if(!isset($sk_options_list['map_on_top']) or (isset($sk_options_list['map_on_top']) and !$sk_options_list['map_on_top'])) echo 'mec-util-hidden'; ?>">
                    <div class="mec-col-4">
                        <label for="mec_skin_list_set_geo_location"><?php _e('Geolocation', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-set-geolocation-focus <?php if((!isset($sk_options_list['set_geolocation']) or (isset($sk_options_list['set_geolocation']) and !$sk_options_list['set_geolocation'])) or (!isset($sk_options_list['map_on_top']) or (isset($sk_options_list['map_on_top']) and !$sk_options_list['map_on_top']))) echo 'mec-util-hidden'; ?>">
                    <div class="mec-col-4">
                        <label for="mec_skin_list_set_geo_location_focus"><?php _e('Disable Geolocation Force Focus', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-toggle-month-divider mec-not-list-fluent">
                    <div class="mec-col-4">
						<label for="mec_skin_list_toggle_month_divider"><?php _e('Toggle for Month Divider', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_grid_skin_options_container">
                ...
                <!-- Start Maximum Date -->
                <div class="mec-form-row">
                    <label class="mec-col-4" for="mec_skin_grid_maximum_date_range"><?php _e('Maximum Date', 'mec'); ?></label>
                    <input type="text" class="mec-col-4 mec_date_picker" name="mec[sk-options][grid][maximum_date_range]" value="<?php echo isset($sk_options_grid['maximum_date_range']) ? esc_attr($sk_options_grid['maximum_date_range']) : ''; ?>" placeholder="<?php _e('Maximum Date', 'mec'); ?>" autocomplete="off" />
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Maximum Date', 'mec'); ?></h5>
                            <div class="content"><p><?php _e('Show events before the specified date.', 'mec'); ?></p></div>
                ...
                <div class="mec-form-row mec-skin-grid-date-format-container <?php if(isset($sk_options_grid['style']) and $sk_options_grid['style'] != 'classic') echo 'mec-util-hidden'; ?>" id="mec_skin_grid_date_format_classic_container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default value is "d F Y', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/grid-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                <div class="mec-form-row mec-skin-grid-date-format-container <?php if(isset($sk_options_grid['style']) and $sk_options_grid['style'] != 'clean') echo 'mec-util-hidden'; ?>" id="mec_skin_grid_date_format_clean_container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default values are d and F', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/grid-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                <div class="mec-form-row mec-skin-grid-date-format-container <?php if(isset($sk_options_grid['style']) and $sk_options_grid['style'] != 'minimal') echo 'mec-util-hidden'; ?>" id="mec_skin_grid_date_format_minimal_container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default values are d and M', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/grid-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                <div class="mec-form-row mec-skin-grid-date-format-container <?php if(isset($sk_options_grid['style']) and $sk_options_grid['style'] != 'modern') echo 'mec-util-hidden'; ?>" id="mec_skin_grid_date_format_modern_container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default values are d, F and l', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/grid-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                <div class="mec-form-row mec-skin-grid-date-format-container <?php if(isset($sk_options_grid['style']) and $sk_options_grid['style'] != 'simple') echo 'mec-util-hidden'; ?>" id="mec_skin_grid_date_format_simple_container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default value is "M d Y"', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/grid-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times" id="mec_skin_grid_localtime">
					<div class="mec-col-4">
						<label for="mec_skin_grid_include_local_time"><?php _e('Include Local Time', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-include-events-times">
                    <div class="mec-col-4">
                        <label for="mec_skin_grid_include_events_times"><?php _e('Include Events Times', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times" id="mec_skin_grid_display_normal_label">
					<div class="mec-col-4">
						<label for="mec_skin_grid_display_label"><?php _e('Display Normal Labels', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher" id="mec_skin_grid_display_reason_for_cancellation">
					<div class="mec-col-4">
						<label for="mec_skin_grid_reason_for_cancellation"><?php _e('Display Reason for Cancellation', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher">
					<div class="mec-col-4">
						<label for="mec_skin_grid_map_on_top"><?php _e('Show Map on top', 'mec'); ?></label>
					</div>
                    <div class="mec-col-4">
                        <?php if(!$this->main->getPRO()): ?>
                        <div class="info-msg"><?php echo sprintf(__("%s is required to use this feature.", 'mec'), '<a href="'.$this->main->get_pro_link().'" target="_blank">'.__('Pro version of Modern Events Calendar', 'mec').'</a>'); ?></div>
                ...
                <div class="mec-form-row mec-switcher mec-set-geolocation <?php if(!isset($sk_options_grid['map_on_top']) or (isset($sk_options_grid['map_on_top']) and !$sk_options_grid['map_on_top'])) echo 'mec-util-hidden'; ?>">
                    <div class="mec-col-4">
                        <label for="mec_skin_grid_set_geo_location"><?php _e('Geolocation', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-set-geolocation-focus <?php if((!isset($sk_options_grid['set_geolocation']) or (isset($sk_options_grid['set_geolocation']) and !$sk_options_grid['set_geolocation'])) or (!isset($sk_options_grid['map_on_top']) or (isset($sk_options_grid['map_on_top']) and !$sk_options_grid['map_on_top']))) echo 'mec-util-hidden'; ?>">
                    <div class="mec-col-4">
                        <label for="mec_skin_grid_set_geo_location_focus"><?php _e('Disable Geolocation Force Focus', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_agenda_skin_options_container">
                ...
                <!-- Start Maximum Date -->
                <div class="mec-form-row">
                    <label class="mec-col-4" for="mec_skin_agenda_maximum_date_range"><?php _e('Maximum Date', 'mec'); ?></label>
                    <input type="text" class="mec-col-4 mec_date_picker" name="mec[sk-options][agenda][maximum_date_range]" value="<?php echo isset($sk_options_agenda['maximum_date_range']) ? esc_attr($sk_options_agenda['maximum_date_range']) : ''; ?>" placeholder="<?php _e('Maximum Date', 'mec'); ?>" autocomplete="off" />
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Maximum Date', 'mec'); ?></h5>
                            <div class="content"><p><?php _e('Show events before the specified date.', 'mec'); ?></p></div>
                ...
                <div class="mec-form-row mec-skin-agenda-date-format-container <?php if(isset($sk_options_agenda['style']) and $sk_options_agenda['style'] != 'clean') echo 'mec-util-hidden'; ?>" id="mec_skin_agenda_date_format_clean_container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default values are l and F j', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/agenda-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times">
                    <div class="mec-col-4">
                        <label for="mec_skin_agenda_include_local_time"><?php _e('Include Local Time', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times" id="mec_skin_agenda_display_normal_label">
					<div class="mec-col-4">
						<label for="mec_skin_agenda_display_label"><?php _e('Display Normal Labels', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher" id="mec_skin_agenda_display_reason_for_cancellation">
					<div class="mec-col-4">
						<label for="mec_skin_agenda_reason_for_cancellation"><?php _e('Display Reason for Cancellation', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_full_calendar_skin_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-4 wn-mec-select" name="mec[sk-options][full_calendar][start_date_type]" id="mec_skin_full_calendar_start_date_type" onchange="if(this.value == 'date') jQuery('#mec_skin_full_calendar_start_date_container').show(); else jQuery('#mec_skin_full_calendar_start_date_container').hide();">
                        <option value="today" <?php if(isset($sk_options_full_calendar['start_date_type']) and $sk_options_full_calendar['start_date_type'] == 'today') echo 'selected="selected"'; ?>><?php _e('Today', 'mec'); ?></option>
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-4 wn-mec-select" name="mec[sk-options][full_calendar][default_view]" id="mec_skin_full_calendar_default_view">
                        <option value="list" <?php echo (!isset($sk_options_full_calendar['list']) or (isset($sk_options_full_calendar['list']) and $sk_options_full_calendar['list'])) ? '' : 'disabled="disabled"'; ?> <?php echo (isset($sk_options_full_calendar['default_view']) and $sk_options_full_calendar['default_view'] == 'list') ? 'selected="selected"' : ''; ?>><?php _e('List View', 'mec'); ?></option>
                        <option value="grid" <?php echo (!isset($sk_options_full_calendar['grid']) or (isset($sk_options_full_calendar['grid']) and $sk_options_full_calendar['grid'])) ? '' : 'disabled="disabled"'; ?> <?php echo (isset($sk_options_full_calendar['default_view']) and $sk_options_full_calendar['default_view'] == 'grid') ? 'selected="selected"' : ''; ?>><?php _e('Grid View', 'mec'); ?></option>
                        <option value="tile" <?php echo (!isset($sk_options_full_calendar['tile']) or (isset($sk_options_full_calendar['tile']) and $sk_options_full_calendar['tile'])) ? '' : 'disabled="disabled"'; ?> <?php echo (isset($sk_options_full_calendar['default_view']) and $sk_options_full_calendar['default_view'] == 'tile') ? 'selected="selected"' : ''; ?>><?php _e('Tile View', 'mec'); ?></option>
                        <option value="yearly" <?php echo (!isset($sk_options_full_calendar['yearly']) or (isset($sk_options_full_calendar['yearly']) and $sk_options_full_calendar['yearly'])) ? '' : 'disabled="disabled"'; ?> <?php echo (isset($sk_options_full_calendar['default_view']) and $sk_options_full_calendar['default_view'] == 'yearly') ? 'selected="selected"' : ''; ?>><?php _e('Yearly View', 'mec'); ?></option>
                        <option value="monthly" <?php echo (!isset($sk_options_full_calendar['monthly']) or (isset($sk_options_full_calendar['monthly']) and $sk_options_full_calendar['monthly'])) ? '' : 'disabled="disabled"'; ?> <?php echo (isset($sk_options_full_calendar['default_view']) and $sk_options_full_calendar['default_view'] == 'monthly') ? 'selected="selected"' : ''; ?>><?php _e('Monthly/Calendar View', 'mec'); ?></option>
                        <option value="weekly" <?php echo (!isset($sk_options_full_calendar['weekly']) or (isset($sk_options_full_calendar['weekly']) and $sk_options_full_calendar['weekly'])) ? '' : 'disabled="disabled"'; ?> <?php echo (isset($sk_options_full_calendar['default_view']) and $sk_options_full_calendar['default_view'] == 'weekly') ? 'selected="selected"' : ''; ?>><?php _e('Weekly View', 'mec'); ?></option>
                        <option value="daily" <?php echo (!isset($sk_options_full_calendar['daily']) or (isset($sk_options_full_calendar['daily']) and $sk_options_full_calendar['daily'])) ? '' : 'disabled="disabled"'; ?> <?php echo (isset($sk_options_full_calendar['default_view']) and $sk_options_full_calendar['default_view'] == 'daily') ? 'selected="selected"' : ''; ?>><?php _e('Daily View', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row mec-not-full_calendar-fluent <?php echo (!isset($sk_options_full_calendar['monthly']) or (isset($sk_options_full_calendar['monthly']) and $sk_options_full_calendar['monthly'])) ? '' : 'mec-util-hidden'; ?>" id="mec_full_calendar_monthly_style">
                    <label class="mec-col-4" for="mec_skin_full_calendar_monthly_style"><?php _e('Monthly Style', 'mec'); ?></label>
                    <select class="mec-col-4 wn-mec-select" name="mec[sk-options][full_calendar][monthly_style]" id="mec_skin_full_calendar_monthly_style">
                        <option value="clean" <?php echo (isset($sk_options_full_calendar['monthly_style']) and $sk_options_full_calendar['monthly_style'] == 'clean') ? 'selected="selected"' : ''; ?>><?php _e('Clean', 'mec'); ?></option>
                        <option value="novel" <?php echo (isset($sk_options_full_calendar['monthly_style']) and $sk_options_full_calendar['monthly_style'] == 'novel') ? 'selected="selected"' : ''; ?>><?php _e('Novel', 'mec'); ?></option>
                        <option value="simple" <?php echo (isset($sk_options_full_calendar['monthly_style']) and $sk_options_full_calendar['monthly_style'] == 'simple') ? 'selected="selected"' : ''; ?>><?php _e('Simple', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-4" for="mec_skin_full_calendar_limit"><?php _e('Events per day', 'mec'); ?></label>
                ...
                <div class="mec-skin-full-calendar-list-wrap">
                    ...
                    <div class="mec-form-row mec-date-format <?php echo (!isset($sk_options_full_calendar['list']) or (isset($sk_options_full_calendar['list']) and $sk_options_full_calendar['list'])) ? '' : 'mec-util-hidden'; ?>">
                        <label class="mec-col-4" for="mec_skin_full_calendar_date_format_list"><?php _e('List View Date Formats', 'mec'); ?></label>
                ...
                <div class="mec-form-row mec-switcher">
                    <div class="mec-col-4">
                        <label for="mec_skin_full_calendar_grid"><?php _e('Grid View', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher">
                    <div class="mec-col-4">
                        <label for="mec_skin_full_calendar_tile"><?php _e('Tile View', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-skin-full-calendar-yearly-wrap">
                    ...
                    <div class="mec-form-row mec-date-format mec-not-full_calendar-fluent <?php echo (isset($sk_options_full_calendar['yearly']) and $sk_options_full_calendar['yearly']) ? '' : 'mec-util-hidden'; ?>">
                        <label class="mec-col-4" for="mec_skin_full_calendar_date_format_yearly_1"><?php _e('Yearly View Date Formats', 'mec'); ?></label>
                ...
                <div class="mec-form-row">
                <?php if(!$this->main->getPRO()): ?>
                    <div class="info-msg"><?php echo sprintf(__("%s is required to use <b>Yearly View</b> skin.", 'mec'), '<a href="'.$this->main->get_pro_link().'" target="_blank">'.__('Pro version of Modern Events Calendar', 'mec').'</a>'); ?></div>
                <?php endif; ?>
                </div>
                <div class="mec-form-row mec-switcher">
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times" id="mec_skin_full_calendar_display_normal_label">
					<div class="mec-col-4">
						<label for="mec_skin_full_calendar_display_label"><?php _e('Display Normal Labels', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher" id="mec_skin_full_calendar_display_reason_for_cancellation">
					<div class="mec-col-4">
						<label for="mec_skin_full_calendar_reason_for_cancellation"><?php _e('Display Reason for Cancellation', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_yearly_view_skin_options_container">
                ...
                <div class="mec-form-row mec-skin-yearly-view-date-format-container mec-not-yearly_view-fluent <?php if(isset($sk_options_yearly_view['style']) and $sk_options_yearly_view['style'] != 'modern') echo 'mec-util-hidden'; ?>" id="mec_skin_yearly_view_date_format_modern_container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default values are l and F j', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/yearly-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times">
                    <div class="mec-col-4">
                        <label for="mec_skin_yearly_view_include_local_time"><?php _e('Include Local Time', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times" id="mec_skin_yearly_view_display_normal_label">
					<div class="mec-col-4">
						<label for="mec_skin_yearly_view_display_label"><?php _e('Display Normal Labels', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher" id="mec_skin_yearly_view_display_reason_for_cancellation">
					<div class="mec-col-4">
						<label for="mec_skin_yearly_view_reason_for_cancellation"><?php _e('Display Reason for Cancellation', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_monthly_view_skin_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-4 wn-mec-select" name="mec[sk-options][monthly_view][style]" id="mec_skin_monthly_view_style" onchange="mec_skin_style_changed('monthly_view', this.value);">
                        ...
                        <option value="novel" <?php if(isset($sk_options_monthly_view['style']) and $sk_options_monthly_view['style'] == 'novel') echo 'selected="selected"'; ?>><?php _e('Novel', 'mec'); ?></option>
                        <option value="simple" <?php if(isset($sk_options_monthly_view['style']) and $sk_options_monthly_view['style'] == 'simple') echo 'selected="selected"'; ?>><?php _e('Simple', 'mec'); ?></option>
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times mec-not-monthly_view-fluent">
                    <div class="mec-col-4">
                        <label for="mec_skin_monthly_view_include_local_time"><?php _e('Include Local Time', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times mec-not-monthly_view-fluent" id="mec_skin_monthly_view_display_normal_label">
					<div class="mec-col-4">
						<label for="mec_skin_monthly_view_display_label"><?php _e('Display Normal Labels', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-not-monthly_view-fluent" id="mec_skin_monthly_view_display_reason_for_cancellation">
					<div class="mec-col-4">
						<label for="mec_skin_monthly_view_reason_for_cancellation"><?php _e('Display Reason for Cancellation', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <!-- <div class="mec-form-row mec-switcher">
					<div class="mec-col-4">
						<label><?php _e('Uppercase Text', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_map_skin_options_container">
                ...
                <div class="mec-form-row mec-switcher mec-set-geolocation-focus <?php if(!isset($sk_options_map['geolocation']) or (isset($sk_options_map['geolocation']) and !$sk_options_map['geolocation'])) echo 'mec-util-hidden'; ?>">
                    <div class="mec-col-4">
                        <label><?php _e('Disable Geolocation Force Focus', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_daily_view_skin_options_container">
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times">
                    <div class="mec-col-4">
                        <label for="mec_skin_daily_view_include_local_time"><?php _e('Include Local Time', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times" id="mec_skin_daily_view_display_normal_label">
					<div class="mec-col-4">
						<label for="mec_skin_daily_view_display_label"><?php _e('Display Normal Labels', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher" id="mec_skin_daily_view_display_reason_for_cancellation">
					<div class="mec-col-4">
						<label for="mec_skin_daily_view_reason_for_cancellation"><?php _e('Display Reason for Cancellation', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_weekly_view_skin_options_container">
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times mec-not-weekly_view-fluent">
                    <div class="mec-col-4">
                        <label for="mec_skin_weekly_view_include_local_time"><?php _e('Include Local Time', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times mec-not-weekly_view-fluent" id="mec_skin_weekly_view_display_normal_label">
					<div class="mec-col-4">
						<label for="mec_skin_weekly_view_display_label"><?php _e('Display Normal Labels', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-not-weekly_view-fluent" id="mec_skin_weekly_view_display_reason_for_cancellation">
					<div class="mec-col-4">
						<label for="mec_skin_weekly_view_reason_for_cancellation"><?php _e('Display Reason for Cancellation', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_timetable_skin_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-4 wn-mec-select" name="mec[sk-options][timetable][style]" id="mec_skin_timetable_style" onchange="mec_skin_style_changed('timetable', this.value); if(this.value == 'clean' || this.value == 'fluent'){ jQuery('.mec-timetable-clean-style-depended').show(); jQuery('.mec-timetable-classic-style-depended').hide(); jQuery('.mec-timetable-modern-style-depended').hide(); } else if ( this.value == 'classic' ) { jQuery('.mec-timetable-classic-style-depended').show(); jQuery('.mec-timetable-clean-style-depended').show(); jQuery('.mec-timetable-modern-style-depended').hide(); } else { jQuery('.mec-timetable-clean-style-depended').hide(); jQuery('.mec-timetable-classic-style-depended').hide(); jQuery('.mec-timetable-modern-style-depended').show(); }">
                        ...
                        <!-- <option value="classic" <?php if(isset($sk_options_timetable['style']) and $sk_options_timetable['style'] == 'classic') echo 'selected="selected"'; ?>><?php _e('Classic', 'mec'); ?></option> -->
                ...
                <div class="mec-timetable-clean-style-depended mec-timetable-fluent">
                    <div class="mec-form-row">
                        <label class="mec-col-4" for="mec_skin_timetable_number_of_days"><?php _e('Number of Days', 'mec'); ?></label>
                    ...
                    <div class="mec-form-row">
                        <label class="mec-col-4" for="mec_skin_timetable_week_start"><?php _e('Week Start', 'mec'); ?></label>
                        <select class="mec-col-4 wn-mec-select" name="mec[sk-options][timetable][week_start]" id="mec_skin_timetable_week_start">
                            <option value="-1" <?php if(isset($sk_options_timetable['week_start']) and $sk_options_timetable['week_start'] == '-1') echo 'selected="selected"'; ?>><?php _e('Inherite from WordPress options', 'mec'); ?></option>
                            <option value="0" <?php if(isset($sk_options_timetable['week_start']) and $sk_options_timetable['week_start'] == '0') echo 'selected="selected"'; ?>><?php _e('Sunday', 'mec'); ?></option>
                            <option value="1" <?php if(isset($sk_options_timetable['week_start']) and $sk_options_timetable['week_start'] == '1') echo 'selected="selected"'; ?>><?php _e('Monday', 'mec'); ?></option>
                            <option value="2" <?php if(isset($sk_options_timetable['week_start']) and $sk_options_timetable['week_start'] == '2') echo 'selected="selected"'; ?>><?php _e('Tuesday', 'mec'); ?></option>
                            <option value="3" <?php if(isset($sk_options_timetable['week_start']) and $sk_options_timetable['week_start'] == '3') echo 'selected="selected"'; ?>><?php _e('Wednesday', 'mec'); ?></option>
                            <option value="4" <?php if(isset($sk_options_timetable['week_start']) and $sk_options_timetable['week_start'] == '4') echo 'selected="selected"'; ?>><?php _e('Thursday', 'mec'); ?></option>
                            <option value="5" <?php if(isset($sk_options_timetable['week_start']) and $sk_options_timetable['week_start'] == '5') echo 'selected="selected"'; ?>><?php _e('Friday', 'mec'); ?></option>
                            <option value="6" <?php if(isset($sk_options_timetable['week_start']) and $sk_options_timetable['week_start'] == '6') echo 'selected="selected"'; ?>><?php _e('Saturday', 'mec'); ?></option>
                        </select>
                    </div>
                </div>
                <div class="mec-timetable-classic-style-depended">
                    <div class="mec-form-row">
                        ...
                        <select class="mec-col-2 wn-mec-select" name="mec[sk-options][timetable][start_time]" id="mec_skin_timetable_start_time">
                            <option value="1" <?php if(isset($sk_options_timetable['start_time']) and $sk_options_timetable['start_time'] == '1') echo 'selected="selected"'; ?>><?php _e('1:00', 'mec'); ?></option>
                            <option value="2" <?php if(isset($sk_options_timetable['start_time']) and $sk_options_timetable['start_time'] == '2') echo 'selected="selected"'; ?>><?php _e('2:00', 'mec'); ?></option>
                            <option value="3" <?php if(isset($sk_options_timetable['start_time']) and $sk_options_timetable['start_time'] == '3') echo 'selected="selected"'; ?>><?php _e('3:00', 'mec'); ?></option>
                            <option value="4" <?php if(isset($sk_options_timetable['start_time']) and $sk_options_timetable['start_time'] == '4') echo 'selected="selected"'; ?>><?php _e('4:00', 'mec'); ?></option>
                            <option value="5" <?php if(isset($sk_options_timetable['start_time']) and $sk_options_timetable['start_time'] == '5') echo 'selected="selected"'; ?>><?php _e('5:00', 'mec'); ?></option>
                            <option value="6" <?php if(isset($sk_options_timetable['start_time']) and $sk_options_timetable['start_time'] == '6') echo 'selected="selected"'; ?>><?php _e('6:00', 'mec'); ?></option>
                            <option value="7" <?php if(isset($sk_options_timetable['start_time']) and $sk_options_timetable['start_time'] == '7') echo 'selected="selected"'; ?>><?php _e('7:00', 'mec'); ?></option>
                            <option value="8" <?php if(isset($sk_options_timetable['start_time']) and $sk_options_timetable['start_time'] == '8') echo 'selected="selected"'; ?>><?php _e('8:00', 'mec'); ?></option>
                            <option value="9" <?php if(isset($sk_options_timetable['start_time']) and $sk_options_timetable['start_time'] == '9') echo 'selected="selected"'; ?>><?php _e('9:00', 'mec'); ?></option>
                            <option value="10" <?php if(isset($sk_options_timetable['start_time']) and $sk_options_timetable['start_time'] == '10') echo 'selected="selected"'; ?>><?php _e('10:00', 'mec'); ?></option>
                            <option value="11" <?php if(isset($sk_options_timetable['start_time']) and $sk_options_timetable['start_time'] == '11') echo 'selected="selected"'; ?>><?php _e('11:00', 'mec'); ?></option>
                            <option value="12" <?php if(isset($sk_options_timetable['start_time']) and $sk_options_timetable['start_time'] == '12') echo 'selected="selected"'; ?>><?php _e('12:00', 'mec'); ?></option>
                        </select>
                        <select class="mec-col-2 wn-mec-select" name="mec[sk-options][timetable][end_time]" id="mec_skin_timetable_end_time">
                            <option value="13" <?php if(isset($sk_options_timetable['end_time']) and $sk_options_timetable['end_time'] == '13') echo 'selected="selected"'; ?>><?php _e('13:00', 'mec'); ?></option>
                            <option value="14" <?php if(isset($sk_options_timetable['end_time']) and $sk_options_timetable['end_time'] == '14') echo 'selected="selected"'; ?>><?php _e('14:00', 'mec'); ?></option>
                            <option value="15" <?php if(isset($sk_options_timetable['end_time']) and $sk_options_timetable['end_time'] == '15') echo 'selected="selected"'; ?>><?php _e('15:00', 'mec'); ?></option>
                            <option value="16" <?php if(isset($sk_options_timetable['end_time']) and $sk_options_timetable['end_time'] == '16') echo 'selected="selected"'; ?>><?php _e('16:00', 'mec'); ?></option>
                            <option value="17" <?php if(isset($sk_options_timetable['end_time']) and $sk_options_timetable['end_time'] == '17') echo 'selected="selected"'; ?>><?php _e('17:00', 'mec'); ?></option>
                            <option value="18" <?php if(isset($sk_options_timetable['end_time']) and $sk_options_timetable['end_time'] == '18') echo 'selected="selected"'; ?>><?php _e('18:00', 'mec'); ?></option>
                            <option value="19" <?php if(isset($sk_options_timetable['end_time']) and $sk_options_timetable['end_time'] == '19') echo 'selected="selected"'; ?>><?php _e('19:00', 'mec'); ?></option>
                            <option value="20" <?php if(isset($sk_options_timetable['end_time']) and $sk_options_timetable['end_time'] == '20') echo 'selected="selected"'; ?>><?php _e('20:00', 'mec'); ?></option>
                            <option value="21" <?php if(isset($sk_options_timetable['end_time']) and $sk_options_timetable['end_time'] == '21') echo 'selected="selected"'; ?>><?php _e('21:00', 'mec'); ?></option>
                            <option value="22" <?php if(isset($sk_options_timetable['end_time']) and $sk_options_timetable['end_time'] == '22') echo 'selected="selected"'; ?>><?php _e('22:00', 'mec'); ?></option>
                            <option value="23" <?php if(isset($sk_options_timetable['end_time']) and $sk_options_timetable['end_time'] == '23') echo 'selected="selected"'; ?>><?php _e('23:00', 'mec'); ?></option>
                            <option value="24" <?php if(isset($sk_options_timetable['end_time']) and $sk_options_timetable['end_time'] == '24') echo 'selected="selected"'; ?>><?php _e('24:00', 'mec'); ?></option>
                        </select>
                    </div>
                </div>
                <!-- Start LocalTime -->
                <div class="mec-form-row mec-switcher mec-include-events-local-times mec-not-timetable-fluent">
                    <div class="mec-col-4">
                        <label for="mec_skin_timetable_include_local_time"><?php _e('Include Local Time', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times mec-not-timetable-fluent" id="mec_skin_timetable_display_normal_label">
					<div class="mec-col-4">
						<label for="mec_skin_timetable_display_label"><?php _e('Display Normal Labels', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-not-timetable-fluent" id="mec_skin_timetable_display_reason_for_cancellation">
					<div class="mec-col-4">
						<label for="mec_skin_timetable_reason_for_cancellation"><?php _e('Display Reason for Cancellation', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_masonry_skin_options_container">
                ...
                <!-- Start Maximum Date -->
                <div class="mec-form-row">
                    <label class="mec-col-4" for="mec_skin_masonry_maximum_date_range"><?php _e('Maximum Date', 'mec'); ?></label>
                    <input type="text" class="mec-col-4 mec_date_picker" name="mec[sk-options][masonry][maximum_date_range]" value="<?php echo isset($sk_options_masonry['maximum_date_range']) ? esc_attr($sk_options_masonry['maximum_date_range']) : ''; ?>" placeholder="<?php _e('Maximum Date', 'mec'); ?>" autocomplete="off" />
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Maximum Date', 'mec'); ?></h5>
                            <div class="content"><p><?php _e('Show events before the specified date.', 'mec'); ?></p></div>
                ...
                <div class="mec-form-row mec-skin-masonry-date-format-container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default values are j and F', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/masonry-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-4 wn-mec-select" name="mec[sk-options][masonry][filter_by]" id="mec_skin_masonry_filter_by">
                        <option value="" <?php if(isset($sk_options_masonry['filter_by']) and $sk_options_masonry['filter_by'] == '') echo 'selected="selected"'; ?>><?php _e('None', 'mec'); ?></option>
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times">
                    <div class="mec-col-4">
                        <label for="mec_skin_masonry_include_local_time"><?php _e('Include Local Time', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times" id="mec_skin_masonry_display_normal_label">
					<div class="mec-col-4">
						<label for="mec_skin_masonry_display_label"><?php _e('Display Normal Labels', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher" id="mec_skin_masonry_display_reason_for_cancellation">
					<div class="mec-col-4">
						<label for="mec_skin_masonry_reason_for_cancellation"><?php _e('Display Reason for Cancellation', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher">
                    <div class="mec-col-4">
                        <label><?php _e('Fit to row', 'mec'); ?></label>
                        <p class="description"><?php _e('Items are arranged into rows. Rows progress vertically. Similar to what you would expect from a layout that uses CSS floats.', 'mec'); ?></p>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher">
                    <div class="mec-col-4">
                        <label><?php _e('Convert Masonry to Grid', 'mec'); ?></label>
                        <p class="description"><?php _e('For using this option, your events should come with image', 'mec'); ?></p>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher">
                    <div class="mec-col-4">
                        <label><?php _e('Load More Button', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_cover_skin_options_container">
                ...
                <div class="mec-form-row mec-skin-cover-date-format-container <?php if(isset($sk_options_cover['style']) and $sk_options_cover['style'] != 'clean') echo 'mec-util-hidden'; ?>" id="mec_skin_cover_date_format_clean_container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default values are d, M and Y', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/cover-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                <div class="mec-form-row mec-skin-cover-date-format-container <?php if(isset($sk_options_cover['style']) and $sk_options_cover['style'] != 'classic') echo 'mec-util-hidden'; ?>" id="mec_skin_cover_date_format_classic_container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default values are "F d" and l', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/cover-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                <div class="mec-form-row mec-skin-cover-date-format-container <?php if(isset($sk_options_cover['style']) and $sk_options_cover['style'] != 'modern') echo 'mec-util-hidden'; ?>" id="mec_skin_cover_date_format_modern_container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default value is "l, F d Y"', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/cover-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times">
                    <div class="mec-col-4">
                        <label for="mec_skin_cover_include_local_time"><?php _e('Include Local Time', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times" id="mec_skin_cover_display_normal_label">
					<div class="mec-col-4">
						<label for="mec_skin_cover_display_label"><?php _e('Display Normal Labels', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher" id="mec_skin_cover_display_reason_for_cancellation">
					<div class="mec-col-4">
						<label for="mec_skin_cover_reason_for_cancellation"><?php _e('Display Reason for Cancellation', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_countdown_skin_options_container">
                ...
                <div class="mec-form-row mec-skin-countdown-date-format-container <?php if(isset($sk_options_countdown['style']) and $sk_options_countdown['style'] != 'clean') echo 'mec-util-hidden'; ?>" id="mec_skin_countdown_date_format_style1_container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default value is "j F Y"', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/countdown-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                ...
                <div class="mec-form-row mec-skin-countdown-date-format-container <?php if(isset($sk_options_countdown['style']) and $sk_options_countdown['style'] != 'style3') echo 'mec-util-hidden'; ?>" id="mec_skin_countdown_date_format_style3_container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default values are j, F and Y', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/countdown-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times">
                    <div class="mec-col-4">
                        <label for="mec_skin_countdown_include_local_time"><?php _e('Include Local Time', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times" id="mec_skin_countdown_display_normal_label">
					<div class="mec-col-4">
						<label for="mec_skin_countdown_display_label"><?php _e('Display Normal Labels', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher" id="mec_skin_countdown_display_reason_for_cancellation">
					<div class="mec-col-4">
						<label for="mec_skin_countdown_reason_for_cancellation"><?php _e('Display Reason for Cancellation', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_available_spot_skin_options_container">
                ...
                <div class="mec-form-row mec-skin-available-spot-date-format-container mec-not-available_spot-fluent">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default values are j and F', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/available-spots-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times">
                    <div class="mec-col-4">
                        <label for="mec_skin_available_spot_include_local_time"><?php _e('Include Local Time', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times" id="mec_skin_available_spot_display_normal_label">
					<div class="mec-col-4">
						<label for="mec_skin_available_spot_display_label"><?php _e('Display Normal Labels', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher" id="mec_skin_available_spot_display_reason_for_cancellation">
					<div class="mec-col-4">
						<label for="mec_skin_available_spot_reason_for_cancellation"><?php _e('Display Reason for Cancellation', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_carousel_skin_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-4 wn-mec-select" name="mec[sk-options][carousel][style]" id="mec_skin_carousel_style" onchange="mec_skin_style_changed('carousel', this.value); if(this.value == 'type4'){ jQuery('.mec-carousel-archive-link').show();jQuery('.mec-carousel-head-text').show();} else { jQuery('.mec-carousel-archive-link').hide(); jQuery('.mec-carousel-head-text').hide();  }">
                        ...
                        <option value="type4" <?php if(isset($sk_options_carousel['style']) and $sk_options_carousel['style'] == 'type4') echo 'selected="selected"'; ?>><?php _e('Type 4', 'mec'); ?></option>
                ...
                <div class="mec-form-row mec-skin-carousel-date-format-container <?php if(isset($sk_options_carousel['style']) and $sk_options_carousel['style'] != 'type1') echo 'mec-util-hidden'; ?>" id="mec_skin_carousel_date_format_type1_container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default values are d, F and Y', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/carousel-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                <div class="mec-form-row mec-skin-carousel-date-format-container <?php if(isset($sk_options_carousel['style']) and $sk_options_carousel['style'] != 'type2') echo 'mec-util-hidden'; ?>" id="mec_skin_carousel_date_format_type2_container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default value is "M d, Y"', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/carousel-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                ...
                <div class="mec-form-row mec-carousel-archive-link">
                    <label class="mec-col-4" for="mec_skin_carousel_archive_link"><?php _e('Archive Link', 'mec'); ?></label>
                ...
                <div class="mec-form-row mec-carousel-head-text">
                    <label class="mec-col-4" for="mec_skin_carousel_head_text"><?php _e('Head Text', 'mec'); ?></label>
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times">
                    <div class="mec-col-4">
                        <label for="mec_skin_carousel_include_local_time"><?php _e('Include Local Time', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times" id="mec_skin_carousel_display_normal_label">
					<div class="mec-col-4">
						<label for="mec_skin_carousel_display_label"><?php _e('Display Normal Labels', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher" id="mec_skin_carousel_display_reason_for_cancellation">
					<div class="mec-col-4">
						<label for="mec_skin_carousel_reason_for_cancellation"><?php _e('Display Reason for Cancellation', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_slider_skin_options_container">
                ...
                <div class="mec-form-row mec-skin-slider-date-format-container <?php if(isset($sk_options_slider['style']) and $sk_options_slider['style'] != 't1') echo 'mec-util-hidden'; ?>" id="mec_skin_slider_date_format_t1_container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default values are d, F and l', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/slider-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times">
                    <div class="mec-col-4">
                        <label for="mec_skin_slider_include_local_time"><?php _e('Include Local Time', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times" id="mec_skin_slider_display_normal_label">
					<div class="mec-col-4">
						<label for="mec_skin_slider_display_label"><?php _e('Display Normal Labels', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher" id="mec_skin_slider_display_reason_for_cancellation">
					<div class="mec-col-4">
						<label for="mec_skin_slider_reason_for_cancellation"><?php _e('Display Reason for Cancellation', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_timeline_skin_options_container">
                ...
                <div class="mec-form-row">
                    <label class="mec-col-4" for="mec_skin_timeline_start_date_type"><?php _e('Start Date', 'mec'); ?></label>
                    <select class="mec-col-4 wn-mec-select" name="mec[sk-options][timeline][start_date_type]" id="mec_skin_timeline_start_date_type" onchange="if(this.value == 'date') jQuery('#mec_skin_timeline_start_date_container').show(); else jQuery('#mec_skin_timeline_start_date_container').hide();">
                        <option value="today" <?php if(isset($sk_options_timeline['start_date_type']) and $sk_options_timeline['start_date_type'] == 'today') echo 'selected="selected"'; ?>><?php _e('Today', 'mec'); ?></option>
                        <option value="tomorrow" <?php if(isset($sk_options_timeline['start_date_type']) and $sk_options_timeline['start_date_type'] == 'tomorrow') echo 'selected="selected"'; ?>><?php _e('Tomorrow', 'mec'); ?></option>
                        <option value="start_current_month" <?php if(isset($sk_options_timeline['start_date_type']) and $sk_options_timeline['start_date_type'] == 'start_current_month') echo 'selected="selected"'; ?>><?php _e('Start of Current Month', 'mec'); ?></option>
                        <option value="start_next_month" <?php if(isset($sk_options_timeline['start_date_type']) and $sk_options_timeline['start_date_type'] == 'start_next_month') echo 'selected="selected"'; ?>><?php _e('Start of Next Month', 'mec'); ?></option>
                        <option value="date" <?php if(isset($sk_options_timeline['start_date_type']) and $sk_options_timeline['start_date_type'] == 'date') echo 'selected="selected"'; ?>><?php _e('On a certain date', 'mec'); ?></option>
                    </select>
                    <div class="mec-col-4 <?php if(!isset($sk_options_timeline['start_date_type']) or (isset($sk_options_timeline['start_date_type']) and $sk_options_timeline['start_date_type'] != 'date')) echo 'mec-util-hidden'; ?>" id="mec_skin_timeline_start_date_container">
                        <input class="mec_date_picker" type="text" name="mec[sk-options][timeline][start_date]" id="mec_skin_timeline_start_date" placeholder="<?php echo sprintf(__('eg. %s', 'mec'), date('Y-n-d')); ?>" value="<?php if(isset($sk_options_timeline['start_date'])) echo $sk_options_timeline['start_date']; ?>" />
                    </div>
                </div>
                <!-- Start Maximum Date -->
                <div class="mec-form-row">
                    <label class="mec-col-4" for="mec_skin_timeline_maximum_date_range"><?php _e('Maximum Date', 'mec'); ?></label>
                    <input type="text" class="mec-col-4 mec_date_picker" name="mec[sk-options][timeline][maximum_date_range]" value="<?php echo isset($sk_options_timeline['maximum_date_range']) ? esc_attr($sk_options_timeline['maximum_date_range']) : ''; ?>" placeholder="<?php _e('Maximum Date', 'mec'); ?>" autocomplete="off" />
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Maximum Date', 'mec'); ?></h5>
                            <div class="content"><p><?php _e('Show events before the specified date.', 'mec'); ?></p></div>
                ...
                <!-- End Maximum Date -->
                <div class="mec-form-row">
                    <label class="mec-col-4" for="mec_skin_timeline_classic_date_format1"><?php _e('Date Formats', 'mec'); ?></label>
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default value is "d F Y', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/timeline-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-4" for="mec_skin_timeline_limit"><?php _e('Limit', 'mec'); ?></label>
                    <input class="mec-col-4" type="number" name="mec[sk-options][timeline][limit]" id="mec_skin_timeline_limit" placeholder="<?php _e('eg. 6', 'mec'); ?>" value="<?php if(isset($sk_options_timeline['limit'])) echo $sk_options_timeline['limit']; ?>" />
                </div>
                <!-- Start LocalTime -->
                <div class="mec-form-row mec-switcher mec-include-events-local-times">
                    <div class="mec-col-4">
                        <label for="mec_skin_timeline_include_local_time"><?php _e('Include Local Time', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times" id="mec_skin_timeline_display_normal_label">
					<div class="mec-col-4">
						<label for="mec_skin_timeline_display_label"><?php _e('Display Normal Labels', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher" id="mec_skin_timeline_display_reason_for_cancellation">
					<div class="mec-col-4">
						<label for="mec_skin_timeline_reason_for_cancellation"><?php _e('Display Reason for Cancellation', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher">
                    <div class="mec-col-4">
                        <label for="mec_skin_timeline_load_more_button"><?php _e('Load More Button', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher">
                    <div class="mec-col-4">
                        <label for="mec_skin_timeline_month_divider"><?php _e('Show Month Divider', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_tile_skin_options_container">
                ...
                <div class="mec-form-row">
                    <label class="mec-col-4" for="mec_skin_tile_start_date_type"><?php _e('Start Date', 'mec'); ?></label>
                    <select class="mec-col-4 wn-mec-select" name="mec[sk-options][tile][start_date_type]" id="mec_skin_tile_start_date_type" onchange="if(this.value == 'date') jQuery('#mec_skin_tile_start_date_container').show(); else jQuery('#mec_skin_tile_start_date_container').hide();">
                        <option value="start_current_month" <?php if(isset($sk_options_tile['start_date_type']) and $sk_options_tile['start_date_type'] == 'start_current_month') echo 'selected="selected"'; ?>><?php _e('Start of Current Month', 'mec'); ?></option>
                        <option value="start_next_month" <?php if(isset($sk_options_tile['start_date_type']) and $sk_options_tile['start_date_type'] == 'start_next_month') echo 'selected="selected"'; ?>><?php _e('Start of Next Month', 'mec'); ?></option>
                        <option value="date" <?php if(isset($sk_options_tile['start_date_type']) and $sk_options_tile['start_date_type'] == 'date') echo 'selected="selected"'; ?>><?php _e('On a certain date', 'mec'); ?></option>
                    </select>
                    <div class="mec-col-4 <?php if(!isset($sk_options_tile['start_date_type']) or (isset($sk_options_tile['start_date_type']) and $sk_options_tile['start_date_type'] != 'date')) echo 'mec-util-hidden'; ?>" id="mec_skin_tile_start_date_container">
                        <input class="mec_date_picker" type="text" name="mec[sk-options][tile][start_date]" id="mec_skin_tile_start_date" placeholder="<?php echo sprintf(__('eg. %s', 'mec'), date('Y-n-d')); ?>" value="<?php if(isset($sk_options_tile['start_date'])) echo $sk_options_tile['start_date']; ?>" />
                    </div>
                </div>
                <div class="mec-form-row mec-skin-tile-date-format-container <?php if(isset($sk_options_tile['style']) and $sk_options_tile['style'] != 'clean') echo 'mec-util-hidden'; ?>" id="mec_skin_tile_date_format_clean_container">
                    <label class="mec-col-4" for="mec_skin_tile_minimal_date_format1"><?php _e('Date Formats', 'mec'); ?></label>
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php _e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default values are j and M', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/list-view-skin/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-4" for="mec_skin_tile_count"><?php _e('Count in row', 'mec'); ?></label>
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times" id="mec_skin_tile_display_normal_label">
					<div class="mec-col-4">
						<label for="mec_skin_tile_display_label"><?php _e('Display Normal Labels', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher" id="mec_skin_tile_display_reason_for_cancellation">
					<div class="mec-col-4">
						<label for="mec_skin_tile_reason_for_cancellation"><?php _e('Display Reason for Cancellation', 'mec'); ?></label>
					</div>
					<div class="mec-col-4">
                ...
                <div id="mec_tile_off_month_options" <?php if(!isset($sk_options_tile['next_previous_button']) or (isset($sk_options_tile['next_previous_button']) and $sk_options_tile['next_previous_button'])) echo 'style="display:none;"'; ?>>
                    <div class="mec-form-row">
                        <label class="mec-col-4" for="mec_skin_tile_limit"><?php _e('Limit', 'mec'); ?></label>
                        <input class="mec-col-4" type="number" name="mec[sk-options][tile][limit]" id="mec_skin_tile_limit" placeholder="<?php _e('eg. 60', 'mec'); ?>" value="<?php if(isset($sk_options_tile['limit'])) echo $sk_options_tile['limit']; ?>" />
                    </div>
                    <div class="mec-form-row mec-switcher">
                        <div class="mec-col-4">
                            <label><?php _e('Load More Button', 'mec'); ?></label>
