...
<div class="mec-fes-form">
    ...
    <div class="mec-fes-form-top-actions">
        ...
        <a class="mec-fes-form-back-to" href="<?php echo $this->link_list_events(); ?>"><?php echo __('Go back to events list', 'mec'); ?></a>
    ...
    <form id="mec_fes_form" enctype="multipart/form-data">
        ...
        <div class="mec-fes-form-cntt">
            <div class="mec-form-row">
                <label for="mec_fes_title"><?php _e('Title', 'mec'); ?><span>*</span></label>
            ...
            <div class="mec-meta-box-fields" id="mec-excerpt">
                <h4><?php _e('Excerpt', 'mec'); ?></h4>
                <div class="mec-form-row">
                    <div class="mec-col-12">
                        <textarea name="mec[excerpt]" id="mec_fes_excerpt" class="widefat" rows="10" title="<?php esc_attr_e('Optional Event Excerpt', 'mec'); ?>" placeholder="<?php esc_attr_e('Optional Event Excerpt', 'mec'); ?>"><?php echo (isset($post->post_excerpt) ? $post->post_excerpt : ''); ?></textarea>
                    </div>
                </div>
            </div>
            <?php endif; ?>
            <div class="mec-meta-box-fields" id="mec-date-time">
                ...
                <div id="mec_meta_box_date_form">
                    ...
                    <div class="mec-form-row">
                        <div class="mec-col-4">
                            <input type="text" class="" name="mec[date][comment]" id="mec_comment" placeholder="<?php _e('Notes on the time', 'mec'); ?>" value="<?php echo esc_attr($comment); ?>" />
                            <p class="description"><?php _e('It shows next to event time on the Single Event Page. You can enter notes such as timezone in this field.', 'mec'); ?></p>
                        </div>
                    </div>
                </div>
        ...
        <div class="mec-fes-form-sdbr">
            ...
            <div class="mec-meta-box-fields" id="mec-event-links">
                ...
                <div class="mec-form-row">
                    ...
                    <input class="mec-col-9" type="text" name="mec[read_more]" id="mec_read_more_link" value="<?php echo esc_attr($read_more); ?>" placeholder="<?php _e('eg. http://yoursite.com/your-event', 'mec'); ?>" />
            ...
            <div class="mec-meta-box-fields" id="mec-event-cost">
                ...
                <div id="mec_meta_box_cost_form">
                    <div class="mec-form-row">
                        <input type="text" class="mec-col-3" name="mec[cost]" id="mec_cost" value="<?php echo esc_attr($cost); ?>" placeholder="<?php _e('Cost', 'mec'); ?>" />
                    </div>
                </div>
            </div>
            <?php endif; ?>
