            ...
            <div class="mec-steps-content-container">
                <div class="mec-steps-header">
                    <div class="mec-steps-header-userinfo">
                        ...
                        <span class="mec-steps-header-add-text"><?php esc_html_e('Adding a Shortcode...', 'mec') ?></span>
                    </div>
                ...
                <div class="mec-steps-content mec-steps-content-1">
                    ...
                    <input type="text" name="shortcode[name]" placeholder="<?php esc_attr_e('Shortcode Name', 'mec'); ?>" id="mec_shortcode_name">
                    <p class="popup-sh-name-required"><?php esc_html_e('Shortcode name is required', 'mec'); ?></p>
                </div>
                ...
                <div class="mec-steps-content mec-steps-content-3">
                    <div class="mec-styles-wrapper">
                        ...
                        <div class="mec-skin-styles mec-styles-full_calendar">
                            <h3><?php _e('Monthly Style', 'mec'); ?></h3>
                            <label class="active">
                        ...
                        <div class="mec-skin-styles mec-styles-cover">
                            ...
                            <label>
                                ...
                                <div><?php _e('Fluent Type 1', 'mec'); ?></div>
                            </label>
                            <label>
                                ...
                                <div><?php _e('Fluent Type 2', 'mec'); ?></div>
                            </label>
                            <label>
                                ...
                                <div><?php _e('Fluent Type 3', 'mec'); ?></div>
                            </label>
                            <label>
                                ...
                                <div><?php _e('Fluent Type 4', 'mec'); ?></div>
                            </label>
                            <?php } ?>
                        </div>
                        ...
                        ?>
                        <h3 for="mec_shortcode_custom_style"><?php _e('Select Style', 'mec'); ?></h3>
                ...
                <div class="mec-steps-content mec-steps-content-4">
                    <div class="mec-multiple-skin-options">
                        <h3><?php _e('Single Event Display Method', 'mec'); ?></h3>
                        <div>
                            <label>
                                <input type="radio" name="shortcode[sed]" value="0" checked>
                                <?php _e('Separate Window', 'mec'); ?>
                            </label>
                            <label>
                                <input type="radio" name="shortcode[sed]" value="m1">
                                <?php _e('Modal Popup', 'mec'); ?>
                            </label>
                        </div>
                    </div>
                    <div class="mec-single-skin-options">
                        <h3 for="mec_shortcode_event_id"><?php _e('Select Event', 'mec'); ?></h3>
                ...
                <div class="mec-steps-content mec-steps-content-5">
                    ...
                    <div class="mec-switcher" id="mec_show_only_past_events_wrapper">
                        <div>
                            ...
                            <p class="description" style="color: red;"><?php echo sprintf(__('It shows %s expired/past events.', 'mec'), '<strong>'.__('only', 'mec').'</strong>'); ?></p>
                        </div>
                        <div>
                ...
                <div class="mec-steps-content mec-steps-content-6">
                    ...
                    <div class="mec-steps-6-results">
                        <div class="mec-popup-shortcode">
                            <h3><?php _e('Your Shortcode', 'mec'); ?></h3>
                            <div class="mec-popup-shortcode-code">
                                <code></code>
                                <button type="button" class="mec-button-copy"><?php _e('Copy', 'mec'); ?></button>
                            </div>
                        </div>
                        <p class="description"><?php _e('Put this shortcode into your desired page.', 'mec'); ?></p>
                    </div>
                </div>
            </div>
        </div>
        <div class="mec-next-previous-buttons">
            <button class="mec-button-prev"><?php _e('Prev', 'mec'); ?><img src="<?php echo plugin_dir_url(__FILE__ ) . '../../../assets/img/popup/popup-prev-icon.svg'; ?>" /></button>
            <button class="mec-button-next"><?php _e('Next', 'mec'); ?><img src="<?php echo plugin_dir_url(__FILE__ ) . '../../../assets/img/popup/popup-next-icon.svg'; ?>" /></button>
            <button class="mec-button-new"><img src="<?php echo plugin_dir_url(__FILE__ ) . '../../../assets/img/popup/popup-new-shortcode-plus.svg'; ?>" /><?php _e('New Shortcode', 'mec'); ?></button>
        </div>
    </div>
</div>
