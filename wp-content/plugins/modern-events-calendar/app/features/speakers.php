...
class MEC_feature_speakers extends MEC_base
{
    ...
    ?>
        ...
        <tr class="form-field">
            <th scope="row">
                <label for="mec_linkedin"><?php _e('LinkedIn', 'mec'); ?></label>
            </th>
            <td>
                <input type="text" placeholder="<?php esc_attr_e('Insert URL of LinkedIn', 'mec'); ?>" name="linkedin" id="mec_linkedin" value="<?php echo $linkedin; ?>" />
            </td>
        </tr>
        <tr class="form-field">
            <th scope="row">
                                 ...
                                 xmlHttp.addEventListener('readystatechange', function (xhr)
                                 {
                                     if(xmlHttp.readyState == 4 && xmlHttp.status == 200)
                                     {
                                         if(xhr.currentTarget.responseText.indexOf('tr') != -1)
                                         {
                                             ...
                                             jQuery('.form-wrap').append('<div class=\"warning-msg\"><p>" . __('Note: You can use the speakers in your event edit/add page > hourly schedule section and speaker widget section!', 'mec') . "</p></div>');
                                         }
                                     }
                                 });
