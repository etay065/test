            ...
            <?php if($this->style == 'type1'): ?>
                ...
                <div class="event-carousel-type2-head clearfix">
                    ...
                    <div class="mec-event-footer-carousel-type2">
                        ...
                        <?php endif; ?>
                        <a class="mec-booking-button mec-bg-color-hover mec-border-color-hover" data-event-id="<?php echo $event->data->ID; ?>" href="<?php echo $this->main->get_event_date_permalink($event, $event->date['start']['date']); ?>" target="_self"><?php echo (is_array($event->data->tickets) and count($event->data->tickets) and !strpos($soldout, '%%soldout%%')) ? $this->main->m('register_button', __('REGISTER', 'mec')) : $this->main->m('view_detail', __('View Detail', 'mec')) ; ?></a>
                        <?php echo $this->booking_button($event); ?>
                    </div>
                </div>
                ...
                <div class="event-carousel-type4-head clearfix">
                    ...
                    <div class="mec-event-hover-carousel-type4">
                        ...
                        <?php echo $this->main->get_normal_labels($event, $display_label).$this->main->display_cancellation_reason($event->data->ID, $reason_for_cancellation); ?><?php do_action('mec_shortcode_virtual_badge', $event->data->ID ); ?>
                        <div class="mec-btn-wrapper"><a class="mec-event-button" data-event-id="<?php echo $event->data->ID; ?>" href="<?php echo $this->main->get_event_date_permalink($event, $event->date['start']['date']); ?>"><?php echo $this->main->m('event_detail', __('EVENT DETAIL', 'mec')); ?></a><?php echo $this->booking_button($event); ?></div>
                    </div>
                </div>
                <?php endif; ?>
            </article>
