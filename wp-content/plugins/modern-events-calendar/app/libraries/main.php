...
class MEC_main extends MEC_base
{
    ...
    public function get_sidebar_menu($active_menu = 'settings')
    {
        ...
        $settings = apply_filters('mec-settings-items-settings', array(
            __('General Options', 'mec') => 'general_option',
            __('Archive Pages', 'mec') => 'archive_options',
            __('Slugs/Permalinks', 'mec') => 'slug_option',
            __('Currency Options', 'mec') => 'currency_option',
            __('Google Recaptcha Options', 'mec') => 'recaptcha_option',
            __('Frontend Event Submission', 'mec') => 'fes_option',
            __('User Profile', 'mec') => 'user_profile_options',
            __('Search Bar', 'mec') => 'search_bar_options',
            __('Mailchimp Integration', 'mec') => 'mailchimp_option',
            __('Campaign Monitor Integration', 'mec') => 'campaign_monitor_option',
            __('MailerLite Integration', 'mec') => 'mailerlite_option',
            __('Constant Contact Integration', 'mec') => 'constantcontact_option',
            __('Active Campaign Integration', 'mec') => 'active_campaign_option',
            __('Upload Field', 'mec') => 'uploadfield_option',
        ), $active_menu);

        $single_event = apply_filters('mec-settings-item-single_event', array(
            __('Single Event Page', 'mec') => 'event_options',
            __('Custom Fields', 'mec') => 'event_form_option',
            __('Countdown Options', 'mec') => 'countdown_option',
            __('Exceptional Days', 'mec') => 'exceptional_option',
            __('Additional Organizers', 'mec') => 'additional_organizers',
            __('Additional Locations', 'mec') => 'additional_locations',
            __('Related Events', 'mec') => 'related_events',
            __('Edit Per Occurrences', 'mec') => 'per_occurrences',
        ), $active_menu);

        $booking = apply_filters('mec-settings-item-booking', array(
            __('Booking', 'mec') => 'booking_option',
            __('Booking Shortcode', 'mec') => 'booking_shortcode',
            __('Coupons', 'mec') => 'coupon_option',
            __('Taxes / Fees', 'mec') => 'taxes_option',
            __('Ticket Variations & Options', 'mec') => 'ticket_variations_option',
            __('Booking Form', 'mec') => 'booking_form_option',
            __('Payment Gateways', 'mec') => 'payment_gateways_option',
        ), $active_menu);

        $modules = apply_filters('mec-settings-item-modules', array(
            __('Speakers', 'mec') => 'speakers_option',
            __('Map Options', 'mec') => 'googlemap_option',
            __('Export Options', 'mec') => 'export_module_option',
            __('Local Time', 'mec') => 'time_module_option',
            __('QR Code', 'mec') => 'qrcode_module_option',
            __('Weather', 'mec') => 'weather_module_option',
            __('Social Networks', 'mec') => 'social_options',
            __('Next Event', 'mec') => 'next_event_option',
            __('BuddyPress Integration', 'mec') => 'buddy_option',
        ), $active_menu);

        $notifications_items = array(
            __('New Event', 'mec') => 'new_event',
            __('User Event Publishing', 'mec') => 'user_event_publishing',
        );

        if($this->getPro())
        {
            $notifications_items = array_merge(array(
                __('Booking', 'mec') => 'booking_notification',
                __('Booking Verification', 'mec') => 'booking_verification',
                __('Booking Confirmation', 'mec') => 'booking_confirmation',
                __('Booking Cancellation', 'mec') => 'cancellation_notification',
                __('Booking Reminder', 'mec') => 'booking_reminder',
                __('Admin', 'mec') => 'admin_notification',
            ), $notifications_items);

            $notifications_items[__('Notifications Per Event', 'mec')] = 'notifications_per_event';
        }
        ...
        <ul class="wns-be-group-menu">
            ...
            <li class="wns-be-group-menu-li mec-settings-menu <?php echo $active_menu == 'single_event' ? 'active' : ''; ?>">
                <a href="<?php echo $this->add_qs_var('tab', 'MEC-single'); ?>" id="" class="wns-be-group-tab-link-a">
                    ...
                    <span class="wns-be-group-menu-title"><?php  _e('Single Event', 'mec'); ?></span>
                </a>
            ...
            <li class="wns-be-group-menu-li mec-settings-menu <?php echo $active_menu == 'booking' ? 'active' : ''; ?>">
                <a href="<?php echo $this->add_qs_var('tab', 'MEC-booking'); ?>" id="" class="wns-be-group-tab-link-a">
                    ...
                    <span class="wns-be-group-menu-title"><?php  _e('Booking', 'mec'); ?></span>
                </a>
            ...
            <li class="wns-be-group-menu-li mec-settings-menu <?php echo $active_menu == 'modules' ? 'active' : ''; ?>">
                <a href="<?php echo $this->add_qs_var('tab', 'MEC-modules'); ?>" id="" class="wns-be-group-tab-link-a">
                    ...
                    <span class="wns-be-group-menu-title"><?php  _e('Modules', 'mec'); ?></span>
                </a>
        ...
        <div class="w-row mec-addons-notification-wrap">
            <div class="w-col-sm-12">
                <div class="w-clearfix w-box mec-addons-notification-box-wrap">
                    <div class="w-box-head">'.__('New Addons For MEC! Now Customize MEC in Elementor', 'mec').'<span><i class="mec-sl-close"></i></span></div>
                    <div class="w-box-content">
                        ...
                        <div class="mec-addons-notification-box-content">
                            <div class="w-box-content">
                                <p>'.__('The time has come at last, and the new practical add-ons for MEC have been released. This is a revolution in the world of Event Calendars. We have provided you with a wide range of features only by having the 4 add-ons below:' , 'mec').'</p>
                                <ol>
                                    <li>'.__('<strong>WooCommerce Integration:</strong> You can now purchase ticket (as products) and Woo products at the same time.' , 'mec').'</li>
                                    <li>'.__('<strong>Event API:</strong> display your events (shortcodes/single event) on other websites without MEC.  Use JSON output features to make your Apps compatible with MEC.' , 'mec').'</li>
                                    <li>'.__('<strong>Multisite Event Sync:</strong> Sync events between your subsites and main websites. Changes in the main one will be inherited by the subsites. you can set these up in the admin panel.' , 'mec').'</li>
                                    <li>'.__('<strong>User Dashboard:</strong> Create exclusive pages for users. These pages can contain ticket purchase information, information about registered events. Users can now log in to purchase tickets.', 'mec').'</li>
                                </ol>
    ...
    public function get_social_networks()
    {
        $social_networks = array(
            ...
            'tumblr'=>array('id'=>'tumblr', 'name'=>__('Tumblr', 'mec'), 'function'=>array($this, 'sn_tumblr')),
            'pinterest'=>array('id'=>'pinterest', 'name'=>__('Pinterest', 'mec'), 'function'=>array($this, 'sn_pinterest')),
            'flipboard'=>array('id'=>'flipboard', 'name'=>__('Flipboard', 'mec'), 'function'=>array($this, 'sn_flipboard')),
            'pocket'=>array('id'=>'pocket', 'name'=>__('GetPocket', 'mec'), 'function'=>array($this, 'sn_pocket')),
            'reddit'=>array('id'=>'reddit', 'name'=>__('Reddit', 'mec'), 'function'=>array($this, 'sn_reddit')),
            'whatsapp'=>array('id'=>'whatsapp', 'name'=>__('WhatsApp', 'mec'), 'function'=>array($this, 'sn_whatsapp')),
            'telegram'=>array('id'=>'telegram', 'name'=>__('Telegram', 'mec'), 'function'=>array($this, 'sn_telegram')),
    ...
    public function sn_email($url, $event)
    {
        ...
        return '<li class="mec-event-social-icon"><a class="email" href="mailto:?subject='.wp_specialchars_decode($event->data->title).'&body='.rawurlencode($url).'" title="'.__('Email', 'mec').'"><i class="mec-fa-envelope"></i></a></li>';
    }
    ...
    public function sn_tumblr($url, $event)
    {
        $occurrence = (isset($_GET['occurrence']) ? sanitize_text_field($_GET['occurrence']) : '');
        if(trim($occurrence) != '') $url = $this->add_qs_var('occurrence', $occurrence, $url);
        return '<li class="mec-event-social-icon"><a class="tumblr" href="https://www.tumblr.com/widgets/share/tool?canonicalUrl='.rawurlencode($url).'&title'.wp_specialchars_decode($event->data->title).'&caption='.wp_specialchars_decode($event->data->title).'" title="'.__('Share on Tumblr', 'mec').'"><i class="mec-fa-tumblr"></i></a></li>';
    ...
    public function sn_pinterest($url, $event)
    {
        ...
        return '<li class="mec-event-social-icon"><a class="pinterest" href="http://pinterest.com/pin/create/button/?url='.rawurlencode($url).'" title="'.__('Share on Pinterest', 'mec').'"><i class="mec-fa-pinterest"></i></a></li>';
    ...
    public function sn_flipboard($url, $event)
    {
        ...
        return '<li class="mec-event-social-icon"><a class="flipboard" href="https://share.flipboard.com/bookmarklet/popout?v=2&title'.wp_specialchars_decode($event->data->title).'=&url='.rawurlencode($url).'" title="'.__('Share on Flipboard', 'mec').'">
    ...
    public function sn_pocket($url, $event)
    {
        ...
        return '<li class="mec-event-social-icon"><a class="pocket" href="https://getpocket.com/edit?url='.rawurlencode($url).'" title="'.__('Share on GetPocket', 'mec').'"><i class="mec-fa-get-pocket"></i></a></li>';
    ...
    public function sn_reddit($url, $event)
    {
        ...
        return '<li class="mec-event-social-icon"><a class="reddit" href="https://reddit.com/submit?url='.rawurlencode($url).'&title='.wp_specialchars_decode($event->data->title).'" title="'.__('Share on Reddit', 'mec').'"><i class="mec-fa-reddit"></i></a></li>';
    ...
    public function sn_telegram($url, $event)
    {
        ...
        return '<li class="mec-event-social-icon"><a class="telegram" href="https://telegram.me/share/url?url='.rawurlencode($url).'&text='.wp_specialchars_decode($event->data->title).'" title="'.__('Share on Telegram', 'mec').'">
    ...
    public function sn_whatsapp($url, $event)
    {
        ...
        return '<li class="mec-event-social-icon"><a class="whatsapp" href="whatsapp://send/?text='.rawurlencode($url).'" title="'.__('Share on WhatsApp', 'mec').'"><i class="mec-fa-whatsapp"></i></a></li>';
    ...
    public function do_endpoints()
    {
        if(get_query_var('verify'))
        {
            ...
            if($status == '1')
            {
                echo '<p class="mec-success">'.__('Your booking already verified!', 'mec').'</p>';
                return false;
            }
        ...
        elseif(get_query_var('cancel'))
        {
            ...
            if($status == '-1')
            {
                echo '<p class="mec-error">'.__('Your booking already canceled!', 'mec').'</p>';
                return false;
            }
            ...
            if($right_now >= $end)
            {
                echo '<p class="mec-error">'.__('The event is already finished!', 'mec').'</p>';
                return false;
            }
            ...
            if($cancellation_period_time)
            {
                ...
                {
                    echo '<p class="mec-error">'.__("The cancelation window is passed.", 'mec').'</p>';
                    return false;
                }
            }
    ...
    public function booking_invoice()
    {
        ...
        if(isset($_GET['method']) and sanitize_text_field($_GET['method']) == 'mec-invoice')
        {
            ...
            {
                wp_die(__('Cannot find the invoice!', 'mec'), __('Invoice is invalid.', 'mec'));
                exit;
            }
            ...
            {
                wp_die(__('Your booking still is not confirmed. You can download it after confirmation!', 'mec'), __('Booking Not Confirmed.', 'mec'));
                exit;
            }

            if(!$event_id)
            {
                wp_die(__('Cannot find the booking!', 'mec'), __('Booking is invalid.', 'mec'));
                exit;
            }
            ...
            if(is_array($bfixed_fields) and count($bfixed_fields) and isset($transaction['fields']) and is_array($transaction['fields']) and count($transaction['fields']))
            {
                ...
                $pdf->Write(20, __('Booking Fields', 'mec'));
                $pdf->Ln();
            ...
            if(isset($transaction['tickets']) and is_array($transaction['tickets']) and count($transaction['tickets']))
            {
                ...
                foreach($transaction['tickets'] as $attendee)
                {
                    ...
                    $pdf->Write(6, ((isset($event->tickets[$attendee['id']]) ? __($this->m('ticket', __('Ticket', 'mec'))).': '.$event->tickets[$attendee['id']]['name'] : '').' '.(isset($event->tickets[$attendee['id']]) ? $book->get_ticket_price_label($event->tickets[$attendee['id']], $booking_time, $event_id) : '')));
            ...
            if(isset($transaction['price_details']) and isset($transaction['price_details']['details']) and is_array($transaction['price_details']['details']) and count($transaction['price_details']['details']))
            {
                ...
                if($coupon_code)
                {
                    $pdf->Write(6, __('Coupon Code', 'mec').": ".$coupon_code);
                    $pdf->Ln();
                }
            ...
            // Geteway
            $pdf->SetFont('DejaVuBold', '', 16);
            $pdf->Write(20, __('Payment', 'mec'));
            $pdf->Ln();

            $pdf->SetFont('DejaVu', '', 12);
            $pdf->Write(6, __('Gateway', 'mec').': ');
            ...
            $pdf->SetFont('DejaVu', '', 12);
            $pdf->Write(6, __('Payment Time', 'mec').': ');
    ...
    public function ical_email()
    {
        ...
        if(isset($_GET['method']) and sanitize_text_field($_GET['method']) == 'ical-email')
        {
            ...
            if($key != md5($book_id))
            {
                wp_die(__('Request is not valid.', 'mec'), __('iCal export stopped!', 'mec'), array('back_link'=>true));
                exit;
            }
    ...
    public function field_text($key, $values = array(), $prefix = 'reg')
    {
        return '<li id="mec_'.$prefix.'_fields_'.$key.'">
            <span class="mec_'.$prefix.'_field_sort">'.__('Sort', 'mec').'</span>
            <span class="mec_'.$prefix.'_field_type">'.__('Text', 'mec').'</span>
            ...
            <span onclick="mec_'.$prefix.'_fields_remove('.$key.');" class="mec_'.$prefix.'_field_remove">'.__('Remove', 'mec').'</span>
            <div>
     ...
     */
     public function field_name($key, $values = array(), $prefix = 'reg')
     {
         return '<li id="mec_'.$prefix.'_fields_'.$key.'">
             <span class="mec_'.$prefix.'_field_sort">'.__('Sort', 'mec').'</span>
             <span class="mec_'.$prefix.'_field_type">'.__('MEC Name', 'mec').'</span>
             '.($prefix == 'event' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%event_field_'.$key.'%%</span>' : ($prefix == 'bfixed' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%booking_field_'.$key.'%%</span>' : '')).'
     ...
     */
     public function field_mec_email($key, $values = array(), $prefix = 'reg')
     {
         return '<li id="mec_'.$prefix.'_fields_'.$key.'">
             <span class="mec_'.$prefix.'_field_sort">'.__('Sort', 'mec').'</span>
             <span class="mec_'.$prefix.'_field_type">'.__('MEC Email', 'mec').'</span>
             '.($prefix == 'event' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%event_field_'.$key.'%%</span>' : ($prefix == 'bfixed' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%booking_field_'.$key.'%%</span>' : '')).'
             <p class="mec_'.$prefix.'_field_options" style="display:none">
                 <label for="mec_'.$prefix.'_fields_'.$key.'_mandatory">
                     <input type="hidden" name="mec['.$prefix.'_fields]['.$key.'][mandatory]" value="1" />
    ...
    public function field_email($key, $values = array(), $prefix = 'reg')
    {
        return '<li id="mec_'.$prefix.'_fields_'.$key.'">
            <span class="mec_'.$prefix.'_field_sort">'.__('Sort', 'mec').'</span>
            <span class="mec_'.$prefix.'_field_type">'.__('Email', 'mec').'</span>
            '.($prefix == 'event' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%event_field_'.$key.'%%</span>' : ($prefix == 'bfixed' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%booking_field_'.$key.'%%</span>' : '')).'
            <p class="mec_'.$prefix.'_field_options">
                <label for="mec_'.$prefix.'_fields_'.$key.'_mandatory">
                    <input type="hidden" name="mec['.$prefix.'_fields]['.$key.'][mandatory]" value="0" />
    ...
    public function field_url($key, $values = array(), $prefix = 'reg')
    {
        return '<li id="mec_'.$prefix.'_fields_'.$key.'">
            <span class="mec_'.$prefix.'_field_sort">'.__('Sort', 'mec').'</span>
            <span class="mec_'.$prefix.'_field_type">'.__('URL', 'mec').'</span>
            '.($prefix == 'event' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%event_field_'.$key.'%%</span>' : ($prefix == 'bfixed' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%booking_field_'.$key.'%%</span>' : '')).'
            <p class="mec_'.$prefix.'_field_options">
                <label for="mec_'.$prefix.'_fields_'.$key.'_mandatory">
                    <input type="hidden" name="mec['.$prefix.'_fields]['.$key.'][mandatory]" value="0" />
    ...
    */
    public function field_file($key, $values = array(), $prefix = 'reg')
    {
        return '<li id="mec_'.$prefix.'_fields_'.$key.'">
            <span class="mec_'.$prefix.'_field_sort">'.__('Sort', 'mec').'</span>
            <span class="mec_'.$prefix.'_field_type">'.__('File', 'mec').'</span>
            '.($prefix == 'event' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%event_field_'.$key.'%%</span>' : ($prefix == 'bfixed' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%booking_field_'.$key.'%%</span>' : '')).'
            <p class="mec_'.$prefix.'_field_options">
                <label for="mec_'.$prefix.'_fields_'.$key.'_mandatory">
                    <input type="hidden" name="mec['.$prefix.'_fields]['.$key.'][mandatory]" value="0" />
    ...
    */
    public function field_date($key, $values = array(), $prefix = 'reg')
    {
        return '<li id="mec_'.$prefix.'_fields_'.$key.'">
            <span class="mec_'.$prefix.'_field_sort">'.__('Sort', 'mec').'</span>
            <span class="mec_'.$prefix.'_field_type">'.__('Date', 'mec').'</span>
            '.($prefix == 'event' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%event_field_'.$key.'%%</span>' : ($prefix == 'bfixed' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%booking_field_'.$key.'%%</span>' : '')).'
            <p class="mec_'.$prefix.'_field_options">
                <label for="mec_'.$prefix.'_fields_'.$key.'_mandatory">
                    <input type="hidden" name="mec['.$prefix.'_fields]['.$key.'][mandatory]" value="0" />
    ...
    public function field_tel($key, $values = array(), $prefix = 'reg')
    {
        return '<li id="mec_'.$prefix.'_fields_'.$key.'">
            <span class="mec_'.$prefix.'_field_sort">'.__('Sort', 'mec').'</span>
            <span class="mec_'.$prefix.'_field_type">'.__('Tel', 'mec').'</span>
            '.($prefix == 'event' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%event_field_'.$key.'%%</span>' : ($prefix == 'bfixed' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%booking_field_'.$key.'%%</span>' : '')).'
            <p class="mec_'.$prefix.'_field_options">
                <label for="mec_'.$prefix.'_fields_'.$key.'_mandatory">
                    <input type="hidden" name="mec['.$prefix.'_fields]['.$key.'][mandatory]" value="0" />
    ...
    public function field_textarea($key, $values = array(), $prefix = 'reg')
    {
        return '<li id="mec_'.$prefix.'_fields_'.$key.'">
            <span class="mec_'.$prefix.'_field_sort">'.__('Sort', 'mec').'</span>
            <span class="mec_'.$prefix.'_field_type">'.__('Textarea', 'mec').'</span>
            '.($prefix == 'event' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%event_field_'.$key.'%%</span>' : ($prefix == 'bfixed' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%booking_field_'.$key.'%%</span>' : '')).'
            <p class="mec_'.$prefix.'_field_options">
                <label for="mec_'.$prefix.'_fields_'.$key.'_mandatory">
                    <input type="hidden" name="mec['.$prefix.'_fields]['.$key.'][mandatory]" value="0" />
    ...
    public function field_p($key, $values = array(), $prefix = 'reg')
    {
        return '<li id="mec_'.$prefix.'_fields_'.$key.'">
            <span class="mec_'.$prefix.'_field_sort">'.__('Sort', 'mec').'</span>
            <span class="mec_'.$prefix.'_field_type">'.__('Paragraph', 'mec').'</span>
            <span onclick="mec_'.$prefix.'_fields_remove('.$key.');" class="mec_'.$prefix.'_field_remove">'.__('Remove', 'mec').'</span>
            <div>
    ...
    public function field_checkbox($key, $values = array(), $prefix = 'reg')
    {
        ...
        $field = '<li id="mec_'.$prefix.'_fields_'.$key.'">
            <span class="mec_'.$prefix.'_field_sort">'.__('Sort', 'mec').'</span>
            <span class="mec_'.$prefix.'_field_type">'.__('Checkboxes', 'mec').'</span>
            '.($prefix == 'event' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%event_field_'.$key.'%%</span>' : ($prefix == 'bfixed' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%booking_field_'.$key.'%%</span>' : '')).'
            <p class="mec_'.$prefix.'_field_options">
                <label for="mec_'.$prefix.'_fields_'.$key.'_mandatory">
                    <input type="hidden" name="mec['.$prefix.'_fields]['.$key.'][mandatory]" value="0" />
        ...
        $field .= '</ul>
                <button type="button" class="mec-'.$prefix.'-field-add-option" data-field-id="'.$key.'">'.__('Option', 'mec').'</button>
    ...
    public function field_radio($key, $values = array(), $prefix = 'reg')
    {
        ...
        $field = '<li id="mec_'.$prefix.'_fields_'.$key.'">
            <span class="mec_'.$prefix.'_field_sort">'.__('Sort', 'mec').'</span>
            <span class="mec_'.$prefix.'_field_type">'.__('Radio Buttons', 'mec').'</span>
            '.($prefix == 'event' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%event_field_'.$key.'%%</span>' : ($prefix == 'bfixed' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%booking_field_'.$key.'%%</span>' : '')).'
            <p class="mec_'.$prefix.'_field_options">
                <label for="mec_'.$prefix.'_fields_'.$key.'_mandatory">
                    <input type="hidden" name="mec['.$prefix.'_fields]['.$key.'][mandatory]" value="0" />
    ...
    public function field_select($key, $values = array(), $prefix = 'reg')
    {
        ...
        $field = '<li id="mec_'.$prefix.'_fields_'.$key.'">
            <span class="mec_'.$prefix.'_field_sort">'.__('Sort', 'mec').'</span>
            <span class="mec_'.$prefix.'_field_type">'.__('Dropdown', 'mec').'</span>
            '.($prefix == 'event' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%event_field_'.$key.'%%</span>' : ($prefix == 'bfixed' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%booking_field_'.$key.'%%</span>' : '')).'
            <p class="mec_'.$prefix.'_field_options">
                <label for="mec_'.$prefix.'_fields_'.$key.'_mandatory">
                    <input type="hidden" name="mec['.$prefix.'_fields]['.$key.'][mandatory]" value="0" />
    ...
    public function field_agreement($key, $values = array(), $prefix = 'reg')
    {
        ...
        $field = '<li id="mec_'.$prefix.'_fields_'.$key.'">
            <span class="mec_'.$prefix.'_field_sort">'.__('Sort', 'mec').'</span>
            <span class="mec_'.$prefix.'_field_type">'.__('Agreement', 'mec').'</span>
            '.($prefix == 'event' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%event_field_'.$key.'%%</span>' : ($prefix == 'bfixed' ? '<span class="mec_'.$prefix.'_notification_placeholder">%%booking_field_'.$key.'%%</span>' : '')).'
            <p class="mec_'.$prefix.'_field_options">
                <label for="mec_'.$prefix.'_fields_'.$key.'_mandatory">
                    <input type="hidden" name="mec['.$prefix.'_fields]['.$key.'][mandatory]" value="0" />
    ...
    public function field_option($field_key, $key, $values = array(), $prefix = 'reg')
    {
        return '<li id="mec_'.$prefix.'_fields_option_'.$field_key.'_'.$key.'">
            <span class="mec_'.$prefix.'_field_option_sort">'.__('Sort', 'mec').'</span>
            <span onclick="mec_'.$prefix.'_fields_option_remove('.$field_key.','.$key.');" class="mec_'.$prefix.'_field_remove">'.__('Remove', 'mec').'</span>
            ...
            $messages = array(
                'taxonomies'=>array(
                    ...
                    'messages'=>array(
                        ...
                        'taxonomy_speakers'=>array('label'=>__('Speaker Plural Label', 'mec'), 'default'=>__('Speakers', 'mec')),
                        'taxonomy_speaker'=>array('label'=>__('Speaker Singular Label', 'mec'), 'default'=>__('Speaker', 'mec')),
                    )
                ),
                'weekdays'=>array(
                ...
                'others'=>array(
                    ...
                    'messages'=>array(
                        'book_success_message'=>array('label'=>__('Booking Success Message', 'mec'), 'default'=>__('Thanks you for booking. Your tickets are booked, booking verification might be needed, please check your email.', 'mec')),
                        'booking_restriction_message1'=>array('label'=>__('Booking Restriction Message 1', 'mec'), 'default'=>__('You selected %s tickets to book but maximum number of tikets per user is %s tickets.', 'mec')),
                        'booking_restriction_message2'=>array('label'=>__('Booking Restriction Message 2', 'mec'), 'default'=>__('You booked %s tickets till now but maximum number of tickets per user is %s tickets.', 'mec')),
                        'booking_restriction_message3'=>array('label'=>__('Booking IP Restriction Message', 'mec'), 'default'=>__('Maximum allowed number of tickets that you can book is %s.', 'mec')),
                        ...
                        'all_day'=>array('label'=>__('All Day', 'mec'), 'default'=>__('All Day', 'mec')),
                    )
                ),
            );
        }
    ...
    public function get_integrated_plugins_for_import()
    {
        return array(
            ...
            'event-espresso' => __('Event Espresso', 'mec'),
            'events-manager-recurring' => __('Events Manager (Recurring)', 'mec'),
            'events-manager-single' => __('Events Manager (Single)', 'mec'),
        );
    }
    ...
    public function advanced_repeating_sort_day($start_of_week = 1, $day = 1)
    {
        ...
        $days = array(__('Sun', 'mec'), __('Mon', 'mec'), __('Tue', 'mec'), __('Wed', 'mec'), __('Thu', 'mec'), __('Fri', 'mec'), __('Sat', 'mec'));
    ...
    public function get_flags($event, $date = NULL)
    {
        ...
        if(is_array($availability) and count($availability))
        {
            ...
            // Check For Return SoldOut Label Exist.
            if($remained_tickets === 0) return str_replace('%%title%%', __('Sold Out', 'mec'), $output_tag) . '<input type="hidden" value="%%soldout%%"/>';
            ...
            if(($total_bookings_limit > 0) and ($remained_tickets <= round(((15 * $total_bookings_limit) / 100)))) return str_replace('%%title%%', __('Last Few Tickets', 'mec'), $output_tag);
    ...
    public function timepicker($args)
    {
        ...
        if($method == 24)
        {
            ...
            ?>
            <select name="<?php echo $name; ?>[<?php echo $hour_key; ?>]" <?php if(trim($id_key)): ?>id="mec_<?php echo $id_key; ?>hour"<?php endif; ?> title="<?php esc_attr_e('Hours', 'mec'); ?>">
                <?php for ($i = 0; $i <= 23; $i++) : ?>
                    <option <?php echo ($time_hour == $i) ? 'selected="selected"' : ''; ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                <?php endfor; ?>
            </select>
            <span class="time-dv">:</span>
            <select name="<?php echo $name; ?>[<?php echo $minutes_key; ?>]" <?php if(trim($id_key)): ?>id="mec_<?php echo $id_key; ?>minutes"<?php endif; ?> title="<?php esc_attr_e('Minutes', 'mec'); ?>">
                <?php for ($i = 0; $i <= 11; $i++) : ?>
        ...
        else
        {
            ...
            <select name="<?php echo $name; ?>[<?php echo $ampm_key; ?>]" <?php if(trim($id_key)): ?>id="mec_<?php echo $id_key; ?>ampm"<?php endif; ?> title="<?php esc_attr_e('AM / PM', 'mec'); ?>">
                <option <?php echo ($time_ampm == 'AM') ? 'selected="selected"' : ''; ?> value="AM"><?php _e('AM', 'mec'); ?></option>
                <option <?php echo ($time_ampm == 'PM') ? 'selected="selected"' : ''; ?> value="PM"><?php _e('PM', 'mec'); ?></option>
            </select>
            <?php
        }
    }
    ...
    {
        if($this->is_ongoing($event)) return '<dd><span class="mec-holding-status mec-holding-status-ongoing">'.__('Ongoing...', 'mec').'</span></dd>';
        elseif($this->is_expired($event)) return '<dd><span class="mec-holding-status mec-holding-status-expired">'.__('Expired!', 'mec').'</span></dd>';
