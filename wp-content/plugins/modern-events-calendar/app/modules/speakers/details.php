...
<div class="mec-speakers-details mec-frontbox" id="mec_speakers_details">
    <h3 class="mec-speakers mec-frontbox-title"><?php if (count($speakers) == 1) : echo $this->m('taxonomy_speaker', __('Speaker', 'mec')); else: echo $this->m('taxonomy_speakers', __('Speakers', 'mec')); endif; ?></h3>
    <ul>
