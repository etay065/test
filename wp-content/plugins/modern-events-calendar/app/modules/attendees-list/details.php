    ...
    <ul>
        ...
        <li>
            ...
            <div class="mec-attendee-profile-link">
                <?php echo '<a href="'.$link.'">'.$name.'</a>' . '<span class="mec-attendee-profile-ticket-number mec-bg-color">'. $total_attendees .'</span>' . '<span class="mec-color-hover"> ' . esc_html__( 'tickets' , 'mec' ) . '<i class="mec-sl-arrow-down"></i></span>' ; ?>
            </div>
