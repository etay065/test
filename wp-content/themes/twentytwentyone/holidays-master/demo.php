...
print_link(trans('Back to today', 'היום'), create_url($now['year'], $now['mon']));
print "</div>";
...
print_link(trans('Previous month', 'החודש הקודם'), create_url($year, $month - 1), '', 'right');
print " ";
...
print_link(trans('Next month', 'החודש הבא'), create_url($year, $month + 1), '', 'left');
